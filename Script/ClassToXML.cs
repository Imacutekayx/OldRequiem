...
namespace Tester
{
    ...
    public static class ClassToXML
    {
        ...
        public static void Save()
        {
            ...
            armors.Add(charHelmet);
            armors.Add(charDress);
            armors.Add(charNecklace);
            armors.Add(ennTunic);
            Armors();
            ...
            characters.Add(new Character("Lennj", true, 300, "Lennj lost his family at his birthday when Angels arrived to kill his race", "Psychomancien", "513", 
            ...
            ennemies.Add(new Ennemy("Goblin", "Small and twisted, this evil creature haunts many dark places", 
            ...
            {
                characters[0], ennemies[0], npcs[0]
            };
            scenes.Add(new Scene(64, 64, "exploration", sceBackground, new List<LayerImage>(),
        ...
        private static void Dialogues()
        {
            ...
            using (XmlWriter writer = XmlWriter.Create("dialogues.xml"))
            {
                ...
                //Loop for dialogues
                foreach(Dictionary<string, Dictionary<string, Dictionary<string, string>>> dialogue in dialogues)
                {
