...
namespace Requiem
{
    ...
    public class VisibilityManager
    {
        ...
        /// <summary>
        /// A function that accepts the X and Y coordinates of a case and 
        /// determines whether the given case blocks the passage of light
        /// </summary>
        /// <param name="x">X of analysed case</param>
        /// <param name="y">Y of analysed case</param>
        /// <param name="octant">Direction</param>
        /// <param name="origin">Launcher's position</param>
        /// <returns>Is blocking light</returns>
        private bool BlocksLight(uint x, uint y, uint octant, Location origin)
        {
            uint nx = Convert.ToUInt32(origin.x), ny = Convert.ToUInt32(origin.y);
            switch (octant)
            {
        ...
        /// <summary>
        /// A function that sets a case to be visible, given its X and Y coordinates
        /// </summary>
        /// <param name="x">X of analysed case</param>
        /// <param name="y">Y of analysed case</param>
        /// <param name="octant">Direction</param>
        /// <param name="origin">Launcher's position</param>
        private void SetVisible(uint x, uint y, uint octant, Location origin)
        {
            uint nx = Convert.ToUInt32(origin.x), ny = Convert.ToUInt32(origin.y);
            switch (octant)
            {
        ...
        /// <summary>
        /// A function that takes the X and Y coordinate of a point and returns the distance from the point to the origin (0,0)
        /// </summary>
        /// <param name="x">X of current case</param>
        /// <param name="y">Y of current case</param>
